...
PRESET_HELP = {
    "🎲 mtry = 1": "Jeder Split sieht nur 1 von 11 Merkmalen - reiner Zufall, welches. Die Bäume sind kaum noch korreliert (0.60 statt 0.77 bei mtry = alle), aber jeder Baum ist für sich schwächer: Testfehler 19.2 % - schlechter als mtry = alle (15.0 %). Dekorrelation allein genügt nicht, die Splits müssen noch etwas taugen.",
    ...
    "📈 Regression": "Regression, mtry = 6: Testfehler 10.1 min gegen 10.3 min bei mtry = alle (= Bagging) und 17.0 min beim Einzelbaum. Der Gain gegenüber Bagging ist bei Regression insgesamt kleiner als bei Klassifikation (siehe Experiment) - hier auf diesem Datensatz sichtbar, im Mittel eher bescheiden.",
}
